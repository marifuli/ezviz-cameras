        ...
        <table id="cameras-table" class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">RTSP Port</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No cameras found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
