...
<div class="bg-white shadow-lg rounded-lg p-8 max-w-md mx-auto">
    ...
    <form action="{{ route('cameras.update', $camera) }}" method="POST" class="space-y-6">
        ...
        <div>
            <label for="port" class="block text-sm font-medium text-gray-700">RTSP Port</label>
        ...
        <div>
            ...
            <input type="text" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="username" name="username" value="{{ $camera->username }}" required>
        </div>

        <div>
            <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
            <input type="password" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" id="password" name="password" value="{{ $camera->password }}" required>
        </div>
