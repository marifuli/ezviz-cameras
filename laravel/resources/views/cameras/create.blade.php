...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Add New Camera</h1>
            <p class="text-gray-600">Configure a new camera for monitoring</p>
        </div>
        ...
        <form method="POST" action="{{ route('cameras.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="port" name="port" required value="{{ old('port', 554) }}" min="1" max="65535"
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" id="server_port" name="server_port" value="{{ old('server_port') }}" min="1" max="65535"
